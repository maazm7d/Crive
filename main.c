 ...
 * In a real build, these come from a shared header.
 * ============================================================ */
...
extern archive_type_t detect_archive_type(const char *path);
...
extern archive_bench_t archive_benchmark(archive_type_t type, int duration_ms);
